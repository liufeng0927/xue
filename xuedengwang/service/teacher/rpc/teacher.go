...
import (
	...
	"xuedengwang/service/teacher/rpc/internal/config"
	"xuedengwang/service/teacher/rpc/internal/server"
...
func Run(context *cli.Context) error {
	...
	s := zrpc.MustNewServer(c.RpcServerConf, func(grpcServer *grpc.Server) {
		pb.RegisterTeacherServer(grpcServer, server.NewTeacherServer(ctx))
