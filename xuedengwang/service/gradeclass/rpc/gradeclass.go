...
import (
	...
	"xuedengwang/service/gradeclass/rpc/internal/config"
	"xuedengwang/service/gradeclass/rpc/internal/server"
...
func Run(context *cli.Context) error {
	...
	s := zrpc.MustNewServer(c.RpcServerConf, func(grpcServer *grpc.Server) {
		pb.RegisterGradeclassServer(grpcServer, server.NewGradeclassServer(ctx))
