...
import (
	...
	"xuedengwang/service/course/rpc/internal/config"
	"xuedengwang/service/course/rpc/internal/server"
...
func Run(context *cli.Context) error {
	...
	s := zrpc.MustNewServer(c.RpcServerConf, func(grpcServer *grpc.Server) {
		pb.RegisterCourseServer(grpcServer, server.NewCourseServer(ctx))
