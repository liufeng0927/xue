...
func newUser(db *gorm.DB, opts ...gen.DOOption) user {
	...
	_user.CreateBy = field.NewInt64(tableName, "create_by")
	_user.CreateTime = field.NewTime(tableName, "create_time")
	_user.Remarks = field.NewString(tableName, "remarks")
	_user.UpdateBy = field.NewInt64(tableName, "update_by")
	...
	_user.UserIcon = field.NewString(tableName, "user_icon")
...
func (u *user) updateTableName(table string) *user {
	...
	u.UserIcon = field.NewString(table, "user_icon")
